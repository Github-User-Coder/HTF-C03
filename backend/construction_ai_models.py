...
class DelayPredictor:
    ...
    def predict(self, X):
        return self.model.predict_proba(X)[:, 1]  # return probability of delay
...
class CarbonEstimator:
    ...
    def calculate_material_impact(self, material_type, quantity):
        return self.emission_factors.get(material_type.lower(), self.emission_factors['default']) * quantity
